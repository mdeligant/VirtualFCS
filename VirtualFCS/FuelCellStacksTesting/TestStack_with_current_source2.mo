...
model TestStack_with_current_source2
  ...
  Electrochemical.Hydrogen.FuelCellStack fuelCellStack(redeclare package Cathode_Medium = Cathode_Medium, m_pt_an = 0.1/100, m_pt_ca = 0.1/100, N_el = 5) annotation(
  ...
  Modelica.Fluid.Sources.MassFlowSource_T SourceWater(nPorts = 1, m_flow = 3, T = 333.15, redeclare package Medium = Coolant_Medium) annotation(
...
equation
  ...
  connect(rampCurrent.p, fuelCellStack.pin_p) annotation(
    Line(points = {{10, 84}, {14, 84}, {14, 40}}, color = {0, 0, 255}));
