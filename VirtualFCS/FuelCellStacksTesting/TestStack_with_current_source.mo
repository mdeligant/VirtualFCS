...
model TestStack_with_current_source
  ...
  Modelica.Fluid.Sources.MassFlowSource_T SourceAir(nPorts = 1, m_flow = 0.114975568, T = 313.15, redeclare package Medium = Cathode_Medium, X = {0.78, 0.196, 0.024}) annotation(
  ...
  Modelica.Fluid.Sources.MassFlowSource_T SourceH2(redeclare package Medium = Anode_Medium, T = 293.15, m_flow = 0.004042092, nPorts = 1, X = {0.7, 0.29, 0.01}) annotation(
