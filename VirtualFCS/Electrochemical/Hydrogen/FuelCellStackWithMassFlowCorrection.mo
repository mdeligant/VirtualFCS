...
model FuelCellStackWithMassFlowCorrection
...
//*** DEFINE CONNECTIONS ***//
  ...
  connect(qWater.port_2, port_b_Air) annotation(
    Line(points = {{120, -34}, {120, -140}, {148, -140}}, color = {0, 127, 255}));
  connect(qH2.port_2, port_b_H2) annotation(
    Line(points = {{-120, 30}, {-120, -140}, {-150, -140}}, color = {0, 127, 255}));
  annotation(
...
end FuelCellStackWithMassFlowCorrection;