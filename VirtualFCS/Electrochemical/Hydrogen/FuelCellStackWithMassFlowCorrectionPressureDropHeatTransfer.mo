...
model FuelCellStackWithMassFlowCorrectionPressureDropHeatTransfer
  ...
  Modelica.Fluid.Interfaces.FluidPort_b port_b_H2(redeclare package Medium = Anode_Medium) annotation(
    Placement(transformation(origin = {-150, -140}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {-110, -70}, extent = {{-10, -10}, {10, 10}})));
  ...
  Modelica.Fluid.Interfaces.FluidPort_a port_a_Coolant(redeclare package Medium = Coolant_Medium) annotation(
    Placement(transformation(origin = {-134, -180}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {-30, -90}, extent = {{-10, -10}, {10, 10}})));
  Modelica.Fluid.Interfaces.FluidPort_b port_b_Coolant(redeclare package Medium = Coolant_Medium) annotation(
    Placement(transformation(origin = {130, -180}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {30, -90}, extent = {{-10, -10}, {10, 10}})));
  Modelica.Fluid.Pipes.DynamicPipe pipeCoolant(redeclare package Medium = Coolant_Medium, T_start = 293.15, diameter = 0.003, length = 1, modelStructure = Modelica.Fluid.Types.ModelStructure.a_vb, nNodes = 1, nParallel = 500, p_a_start = 102502, use_HeatTransfer = true) annotation(
    Placement(transformation(origin = {0, -180}, extent = {{-10, 10}, {10, -10}})));
  ...
  Modelica.Blocks.Math.Gain H2_mflow(k = 0.0020/(96485*2)*N_FC_stack) annotation(
  ...
  Modelica.Blocks.Math.Gain O2_mflow(k = -0.016/(96485*2)*N_FC_stack) annotation(
    Placement(transformation(origin = {26, 64}, extent = {{-8, -8}, {8, 8}})));
  Modelica.Thermal.HeatTransfer.Components.ThermalConductor thermalConductor(G = 20000) annotation(
    Placement(transformation(origin = {0, -206}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  Modelica.Thermal.HeatTransfer.Interfaces.HeatPort_a heatPort annotation(
    Placement(transformation(origin = {0, -284}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {0, 70}, extent = {{-10, -10}, {10, 10}})));
  Modelica.Thermal.HeatTransfer.Components.HeatCapacitor heatCapacitor(C = Cp_FC_stack*m_FC_stack, T(fixed = true, start = 293.15), der_T(fixed = false)) annotation(
    Placement(transformation(origin = {0, -244}, extent = {{-10, -10}, {10, 10}})));
  Modelica.Thermal.HeatTransfer.Sources.PrescribedHeatFlow prescribedHeatFlow annotation(
    Placement(transformation(origin = {48, -254}, extent = {{10, -10}, {-10, 10}})));
  Modelica.Electrical.Analog.Basic.Ground ground annotation(
    Placement(visible = true, transformation(origin = {-100, 128}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Thermal.HeatTransfer.Sensors.TemperatureSensor temperatureSensor annotation(
    Placement(transformation(origin = {-50, -232}, extent = {{10, -10}, {-10, 10}}, rotation = -90)));
  ...
  Modelica.Blocks.Math.Gain H2O_mflow(k = -0.018/(96485*2)*N_FC_stack) annotation(
    Placement(transformation(origin = {36, 0}, extent = {{-8, -8}, {8, 8}})));
  Modelica.Fluid.Pipes.DynamicPipe pipeHydrogenHeatTransfer(redeclare model FlowModel = Modelica.Fluid.Pipes.BaseClasses.FlowModels.DetailedPipeFlow, redeclare model HeatTransfer = Modelica.Fluid.Pipes.BaseClasses.HeatTransfer.LocalPipeFlowHeatTransfer, redeclare package Medium = Anode_Medium, diameter = 0.003, length = 10, modelStructure = Modelica.Fluid.Types.ModelStructure.a_v_b, nNodes = 1, nParallel = 500, p_a_start = 150000, use_HeatTransfer = true) annotation(
    Placement(transformation(origin = {-119, -84}, extent = {{10, 10}, {-10, -10}}, rotation = 90)));
  Modelica.Fluid.Pipes.DynamicPipe pipeAirHeatTransfer(redeclare model FlowModel = Modelica.Fluid.Pipes.BaseClasses.FlowModels.DetailedPipeFlow, redeclare model HeatTransfer = Modelica.Fluid.Pipes.BaseClasses.HeatTransfer.LocalPipeFlowHeatTransfer, redeclare package Medium = Cathode_Medium, diameter = 0.004, length = 10, modelStructure = Modelica.Fluid.Types.ModelStructure.a_v_b, nNodes = 1, nParallel = 500, p_a_start = 150000, use_HeatTransfer = true) annotation(
    Placement(transformation(origin = {121, -84}, extent = {{-10, 10}, {10, -10}}, rotation = -90)));
  Modelica.Thermal.HeatTransfer.Components.ThermalConductor thermalConductor_H2(G = 20000) annotation(
    Placement(transformation(origin = {-65, -85}, extent = {{-10, -10}, {10, 10}})));
  Modelica.Thermal.HeatTransfer.Components.ThermalConductor thermalConductor_air(G = 20000) annotation(
    Placement(transformation(origin = {65, -81}, extent = {{-10, -10}, {10, 10}})));
equation
//*** DEFINE EQUATIONS ***//
// Redeclare variables
...
//*** DEFINE CONNECTIONS ***//
  connect(pipeCoolant.port_b, port_b_Coolant) annotation(
    Line(points = {{10, -180}, {130, -180}}, color = {255, 0, 0}, thickness = 1));
  connect(pipeCoolant.port_a, port_a_Coolant) annotation(
    Line(points = {{-10, -180}, {-134, -180}}, color = {0, 0, 255}, thickness = 1));
  ...
  connect(O2_mflow.y, O2_sink.m_flow_in) annotation(
    Line(points = {{35, 64}, {35, 48}, {74, 48}}, color = {0, 0, 127}));
  ...
  connect(thermalConductor.port_b, pipeCoolant.heatPorts[1]) annotation(
    Line(points = {{0, -196}, {0, -184}}, color = {191, 0, 0}));
  connect(thermalConductor.port_a, heatCapacitor.port) annotation(
    Line(points = {{0, -216}, {0, -216}, {0, -254}, {0, -254}}, color = {191, 0, 0}));
  connect(heatCapacitor.port, heatPort) annotation(
    Line(points = {{0, -254}, {0, -254}, {0, -284}, {0, -284}}, color = {191, 0, 0}));
  connect(heatCapacitor.port, prescribedHeatFlow.port) annotation(
    Line(points = {{0, -254}, {38, -254}, {38, -254}, {38, -254}}, color = {191, 0, 0}));
  ...
  connect(temperatureSensor.port, heatCapacitor.port) annotation(
    Line(points = {{-50, -242}, {-50, -242}, {-50, -254}, {2, -254}, {2, -254}, {0, -254}}, color = {191, 0, 0}));
  connect(temperatureSensor.T, H2_sink.T_in) annotation(
    Line(points = {{-50, -221}, {-50, 44}, {-68, 44}, {-68, 46}}, color = {0, 0, 127}));
  ...
  connect(currentSensor.i, O2_mflow.u) annotation(
    Line(points = {{0, 90}, {10, 90}, {10, 64}, {16, 64}}, color = {0, 0, 127}));
  connect(port_a_Air, qAir.port_1) annotation(
    Line(points = {{150, 80}, {120, 80}, {120, 50}}, color = {0, 170, 255}, thickness = 1));
  connect(qAir.port_2, qWater.port_1) annotation(
    Line(points = {{120, 30}, {120, -14}}, color = {0, 127, 255}, thickness = 1));
  connect(H2O_mflow.y, H2O_source.m_flow_in) annotation(
    Line(points = {{45, 0}, {61, 0}, {61, -16}, {76, -16}}, color = {0, 0, 127}));
  connect(currentSensor.i, H2O_mflow.u) annotation(
    Line(points = {{0, 90}, {0, 0}, {26, 0}}, color = {0, 0, 127}));
  connect(H2O_source.T_in, temperatureSensor.T) annotation(
    Line(points = {{74, -20}, {-50, -20}, {-50, -220}}, color = {0, 0, 127}));
  connect(H2O_source.ports[1], qWater.port_3) annotation(
    Line(points = {{96, -24}, {110, -24}}, color = {0, 127, 255}));
  connect(pipeHydrogenHeatTransfer.port_b, port_b_H2) annotation(
    Line(points = {{-118, -94}, {-120, -94}, {-120, -140}, {-150, -140}}, color = {0, 127, 255}));
  connect(pipeAirHeatTransfer.port_a, qWater.port_2) annotation(
    Line(points = {{122, -74}, {122, -34}, {120, -34}}, color = {0, 127, 255}));
  connect(pipeAirHeatTransfer.port_b, port_b_Air) annotation(
    Line(points = {{122, -94}, {120, -94}, {120, -140}, {148, -140}}, color = {0, 127, 255}));
  connect(qH2.port_2, pipeHydrogenHeatTransfer.port_a) annotation(
    Line(points = {{-120, 30}, {-120, -22}, {-118, -22}, {-118, -74}}, color = {0, 127, 255}));
  connect(thermalConductor_air.port_b, pipeAirHeatTransfer.heatPorts[1]) annotation(
    Line(points = {{75, -81}, {99, -81}, {99, -84}, {116, -84}}, color = {191, 0, 0}));
  connect(thermalConductor_air.port_a, heatCapacitor.port) annotation(
    Line(points = {{55, -81}, {26, -81}, {26, -254}, {0, -254}}, color = {191, 0, 0}));
  connect(thermalConductor_H2.port_b, heatCapacitor.port) annotation(
    Line(points = {{-54, -84}, {-22, -84}, {-22, -254}, {0, -254}}, color = {191, 0, 0}));
  connect(thermalConductor_H2.port_a, pipeHydrogenHeatTransfer.heatPorts[1]) annotation(
    Line(points = {{-74, -84}, {-114, -84}}, color = {191, 0, 0}));
  annotation(
    Diagram(coordinateSystem(extent = {{-150, -300}, {150, 150}}, initialScale = 0.1)),
    Icon(coordinateSystem(extent = {{-150, -300}, {150, 150}}, initialScale = 0.1), graphics = {Line(origin = {20.1754, 1.92106}, points = {{0, 78}, {0, -80}, {0, -82}}), Rectangle(origin = {80, 0}, fillColor = {0, 178, 227}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, extent = {{-20, 100}, {20, -100}}), Line(origin = {40.1315, 2}, points = {{0, 78}, {0, -80}, {0, -82}}), Line(origin = {0.219199, 1.92106}, points = {{0, 78}, {0, -80}, {0, -82}}), Line(origin = {-40.0001, 1.61404}, points = {{0, 78}, {0, -80}, {0, -82}}), Rectangle(origin = {-80, 0}, fillColor = {170, 0, 0}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, extent = {{-20, 100}, {20, -100}}), Text(origin = {10, -54}, textColor = {255, 0, 0}, extent = {{-11, 6}, {11, -6}}, textString = "K"), Line(origin = {-20.0439, -0.307018}, points = {{0, 80}, {0, -80}, {0, -80}}), Rectangle(origin = {35, 54}, fillColor = {177, 177, 177}, fillPattern = FillPattern.Vertical, extent = {{-95, 26}, {25, -134}}), Text(origin = {-80, 6}, extent = {{-26, 24}, {26, -24}}, textString = "A"), Text(origin = {80, 6}, extent = {{-26, 24}, {26, -24}}, textString = "C")}),
...
end FuelCellStackWithMassFlowCorrectionPressureDropHeatTransfer;